...
import 'package:responsive_login_ui/views/userCheck_view.dart';
...
class _SignUpViewState extends State<SignUpView> {
  ...
  creatSignUpAlertDialog(BuildContext context) {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
              ...
              MaterialButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (ctx) => const UserCheckView()));
                },
              ),
            ],
          );
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          ...
          if (_formKey.currentState!.validate()) {
            ...
            creatSignUpAlertDialog(context);
          } else {
